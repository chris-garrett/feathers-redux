...
[![Build Status](https://api.travis-ci.org/chris-garrett/feathers-redux-immutablejs.png?branch=master)](https://travis-ci.org/chris-garrett/feathers-redux-immutablejs)
